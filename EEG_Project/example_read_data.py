...
def dataset(k):
    eeg = scio.loadmat("./data/example_train_data.mat")
    label = scio.loadmat("./data/example_train_label.mat")
    data = eeg["data"]
    label = label["label"]
    ...
    # subject-dependent
    x_train = norm_data[k * 3394:k * 3394+2010]
    ...
    # subject-independent
    # if k == 0:
    #     x_train = norm_data[(k + 1) * 3394: (k + 15) * 3394]
    ...
    #     x_train2 = norm_data[(k + 1) * 3394:15 * 3394]
